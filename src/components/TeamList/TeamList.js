...
export const TeamList = () => {
  ...
  async function deleteemployee(id) {
    let result = await fetch("https://gentle-fortress-49662.herokuapp.com/api/delete-team/" + id, {
      method: "DELETE",
      headers: {
  ...
  async function getData() {
    ...
    let result = await fetch("https://gentle-fortress-49662.herokuapp.com/api/get/teams", {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("login")}`,
      },
  ...
  const Edit = async(id) => {
    ...
    let result = await fetch ("https://gentle-fortress-49662.herokuapp.com/api/get/team-one/"+id,{
      method:"GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("login")}`,
      }
